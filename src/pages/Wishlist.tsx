import { ArrowLeft, ArrowUp, Heart, ShoppingBag, Trash2, ShoppingCart } from 'lucide-react';
...
export default function WishlistPage({
  ...
  return (
    ...
    >
      {/* 1. Sub-Header Navigation Ribbon with Conditional Back & Back to Top */}
      <div
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-3">
          ...
          <button
            type="button"
            id="wishlist-back-to-top-btn"
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all shadow-xs active:scale-95 border cursor-pointer ${
              isLightMode
                ? 'bg-white hover:bg-neutral-50 text-neutral-800 border-[#EADFC9] hover:border-[#F5A623] hover:text-[#0F1A3C]'
                : 'bg-[#0B1B32] hover:bg-[#122644] text-neutral-200 border-[#162744] hover:border-[#F5A623] hover:text-[#F5A623]'
            }`}
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute top-3 right-3 p-1.5 bg-black/70 hover:bg-rose-600 text-white rounded-full transition-colors z-10 cursor-pointer shadow-sm"
